...
urlpatterns = [
    ...
    path('usuarios/novo/', views_user.adicionar_usuario, name='adicionar_usuario'),
    path('usuarios/<int:pk>/editar/', views_user.editar_usuario, name='editar_usuario'),
    path('usuarios/<int:pk>/senha/', views_user.resetar_senha, name='resetar_senha'),
    path('usuarios/<int:pk>/desativar/', views_user.desativar_usuario, name='desativar_usuario'),
    path('usuarios/<int:pk>/excluir/', views_user.excluir_usuario, name='excluir_usuario'),
